...
const BASE_URL = 'https://tmdb-proxy-flax.vercel.app';
//const API_URL = BASE_URL + '/trending/movie/day?'+API_KEY;
const API_URL = BASE_URL + '/trending/movie/day?';
...
const API_URL = BASE_URL + '/trending/movie/day';
const IMG_URL = 'https://image.tmdb.org/t/p/w500';
const searchURL = BASE_URL + '/search/movie?query='; // Removed API_KEY since it's not needed
