      ...
      if (videoData) {
        ...
        if (videoData.results.length > 0) {
          ...
          videoData.results.forEach((video, idx) => {
            ...
            if (site === 'YouTube') {
              embed.push(`
                <iframe src="https://vidlink.pro/movie/${id}?player=jw&multiLang=true" class="embed hide responsive-iframe" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
